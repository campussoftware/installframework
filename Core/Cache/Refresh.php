<?php
    class Core_Cache_Refresh 
    {
        ...
        public function setNodeActions($rs)
        {
            ...
            $core_node_actions=Core::covertStringToArray($core_node_actions);
            $qry=new Core_DataBase_ProcessQuery();
            ...
            $qry->addWhere("lower(core_node_actions.short_code) in('".Core::covertArrayToString($core_node_actions,"','")."')");
