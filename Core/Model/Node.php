<?php
    class Core_Model_Node extends Core_Model_Abstract
    {
        ...
        {              
            ...
            $filePath=$sourceNodeObj->_filePath[$FieldName]['storagefolder'];
        ...
        public function defaultDependeeFilter($FieldName)
        {
            ...
            $methodName=Core::covertStringToMethod($FieldName."_addDescriptorFieldsFilter");
